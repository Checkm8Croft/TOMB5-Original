...
//    int t00;
    ...
    t0 = SubPolyGTLoopRL1(5, t0, t1, (uintptr_t)s1);
        ...
        if (t7 != 0)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        t2 = RGB1;
                        SubdivSetup3RL1(a3, fp, (int*)t3, (int*)t4, (int*)t5, (uintptr_t)t1, t2);
                        t5 = ((int*)t6)[0];
                        t7 = ((int*)t6)[4];
...
char* SubPolyGT3RL1(int* t0, int* t1, int* s1, int* a3, int s3, int fp, int s0)
{
    ...
    t0 = SubPolyGTLoopRL1(3, t0, t1, (uintptr_t)s1);
    gp = 3;
    t1 = (int*)RGB2;
    t2 = RGB1;
        ...
        if (ClipXYRL1(t1, t2, t3, t4) == 0)
        {
            ...
            if (t5 < 0x9E0)
            {
                ...
                if (at != 0)
                {
                    ...
                    s3 = 0;
                    a3 = (uintptr_t)SubPolyGT3RL1((int*)&TriVertTableRL1, (int*)&s1[804], (int*)s1, (int*)a3, s3, fpp, (uintptr_t)s0);
        ...
        if (t5 == 0)
        {
            ...
            if (t5 < 0x9E0)
            {
                ...
                if (at != 0)
                {
                    ...
                    gp = (uintptr_t)InitSubdivisionRL1((int*)s1, t1, s444, &fpp, t5, t2, s555, gp, t6, &t3, s666, s3, &t7, &s777);
                    ...
                    a3 = (uintptr_t)SubPolyGT4RL1((int*)&QuadVertTableRL1, (int*)&s1[824], (int*)s1, (int*)a3, (uintptr_t)s0, s3, fpp);
                    t0 = (LB1 & 0xFFFF) | ((LB2 & 0xFFFF) << 16);
                    at = BFC;
                    t9 = DQA;
